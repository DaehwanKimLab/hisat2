...
static void printHelp(ostream& out) {
    ...
    out << "Usage:" << endl
        << "build-table [options]* --sam <sam> --ref <ref> --table-name <table> --base-change <char1,char2>" << endl
        << "  <sam>                     SORTED SAM filename generated by sequence aligner." << endl
        << "  <ref>                     reference file (should be FASTA format)." << endl
        << "  <table>                   file name to save the 3n table." << endl
