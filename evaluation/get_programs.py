...
def get_aligners():
    ...
    files = ["hisat2", "hisat2-align-s", "hisat2-build", "hisat2-build-s", "hisat2-inspect", "hisat2-inspect-s", "extract_splice_sites.py", "hisat2_extract_snps_haplotypes_UCSC.py", "hisat2_simulate_reads.py", "hisat2_trans_to_genome.py", "hisat2_extract_transcript_graph.py"]
    os.chdir("bin")
    for file in files:
